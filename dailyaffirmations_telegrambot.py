...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text("Hello! 🌟 I am your Affirmation Bot. Type /affirmation to receive a positive message.")

async def send_affirmation(update: Update, context: CallbackContext) -> None:
    """Send a random affirmation when the /affirmation command is used."""
...
def main():
    ...
    app.add_handler(CommandHandler("affirmation", send_affirmation))
